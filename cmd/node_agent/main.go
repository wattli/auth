...
func init() {
	...
	flags.StringVar(&naConfig.NodeIdentityPrivateKeyFile, "na-key", "/etc/certs/na-key.pem", "Node identity private key file")
	...
	flags.StringVar(&naConfig.RootCACertFile, "root-cert", "/etc/certs/root-cert.pem", "Root Certificate file")
